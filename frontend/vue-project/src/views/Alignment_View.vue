...
const cards = ref([
  { title: 'Card 1', subtitle: 'Subtitle 1', image: new URL('@/assets/HoodWink.jpg', import.meta.url).href },
  { title: 'Card 2', subtitle: 'Subtitle 2', image: new URL('@/assets/Kenz.jpg', import.meta.url).href },
